    ...
    <footer>
        <div id="style-well-odd" class="well">
  		...
  		<div class="media-body">
                    ...
                    <ul class="list-inline list-unstyled">
                        <li><span><i class="glyphicon glyphicon-calendar"></i> {{time_elapsed_string('2016-11-15 17:01:15')}} </span></li>
                    </ul>
                </div>
            </div>
        </div>
        <div id="style-well-even" class="well">
  		...
  		<div class="media-body">
                    ...
                    <ul class="list-inline list-unstyled">
                        <li><span><i class="glyphicon glyphicon-calendar"></i> {{ time_elapsed_string('2016-11-10 06:33:29') }} </span></li>
                    </ul>
                </div>
            </div>
    </div>
